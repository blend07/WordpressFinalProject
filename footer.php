...
<div class="copyright-wrapper">
  <div class="container">
    <div class="design-by"><?php bloginfo('name'); ?> <?php esc_html_e('Theme By ','skt-towing');?> <?php if( is_home() && is_front_page() || is_home() || is_front_page()) {?>
        <a href="<?php echo esc_url('https://www.sktthemes.org/shop/free-auto-wordpress-theme/');?>" target="_blank">
        <?php esc_html_e('SKT Towing','skt-towing'); ?>
        </a>
        <?php } else {?>
        <?php esc_html_e('SKT Towing','skt-towing'); ?>
        <?php } ?></div>
